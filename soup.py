...
def stats_jogos(links_relatorios):
    for idx, url in enumerate(links_relatorios):
        ...
        tecnicos = list(t.text for t in soup.find_all("div", class_="datapoint"))
...
subs_casa = escalacao_casa(soup, gols, tecnicos, subs)
subs_fora = escalacao_fora(soup, gols, tecnicos, subs)
